const contractAddress = "0x2e3B959F382E86455E129376ce28A3766faF5142"; //Replace with your own contract address
const chain = 'rinkeby'; // rinkeby or polygon

const welcome_h1 = "This is The Space Nuts Invaders NFT Project!";
const welcome_h2 = "Connect to MetaMask to Get Started";
const welcome_p = 'The Space Nuts Invaders NFT is dedicated to building its community and utility until we reach our goal of a MetaSpace VR that affordable and profitable; not just for those who pay but for those who play. Join our discord community to find out when the Nuts drop. <a href="https://discord.gg/t5hWJ6g"  target="_blank" rel="noopener noreferrer">codeSTACKr</a> YouTube channel.';
const h1_presale_coming_soon = "NUTs Dropping Soon!!";
const h1_presale_mint = "Pre-Sale Minting Open!!";
const h1_public_mint = "Public Minting Open!!";
const h2_presale_coming_soon = "Pre-Sale Minting Countdown";
const h2_presale_mint = "Public Minting Countdown";
const p_presale_coming_soon = "Space Nuts Invaders landing on your blockchain soon. Stay tuned for updates!";
...
const button_presale_mint_whitelisted = "Mint your Space Nut";
